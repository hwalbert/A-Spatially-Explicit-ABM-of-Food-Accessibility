...
to setup ;load the gis data
  clear-all
  reset-ticks
  gis:load-coordinate-system (word "Data for DC Model/Shaped DC CensusBlock Data.prj")
  set supermarkets gis:load-dataset "Data for DC Model/DCSupermarkets.shp" ;;;this is the store location data
  set censusBlocks gis:load-dataset "Data for DC Model/Shaped DC CensusBlock Data.shp"
  set notSupermarkets gis:load-dataset "Data for DC Model/DCNOTSupermarkets.shp"
  set wards gis:load-dataset "Data for DC Model/Shaped Ward and Health Data.shp"
end
